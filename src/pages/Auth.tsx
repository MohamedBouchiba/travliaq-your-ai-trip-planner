...
import { Loader2, Eye, EyeOff, Mail, Send } from 'lucide-react';
import { z } from 'zod';
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-secondary via-secondary/95 to-primary/10 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-card backdrop-blur-xl border border-border rounded-2xl shadow-[var(--shadow-deep)] p-8">
            {/* Header */}
            ...
            <div className="space-y-3.5">
              ...
              <Button
                type="button"
                size="lg"
                className="w-full bg-white hover:bg-gray-50 text-gray-800 border border-gray-300 shadow-sm hover:shadow transition-all duration-200 h-12 font-medium justify-center"
              ...
              <Button
                type="button"
                size="lg"
                className="w-full bg-[#0A66C2] hover:bg-[#004182] text-white shadow-sm hover:shadow transition-all duration-200 h-12 font-medium justify-center"
              ...
              >
                {loading ? (
                  ...
                  <>
                    <svg className="mr-3 h-5 w-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Button
                type="button"
                size="lg"
                className="w-full bg-[#1877F2] hover:bg-[#166FE5] text-white shadow-sm hover:shadow transition-all duration-200 h-12 font-medium justify-center"
              ...
              <div className="relative py-4">
                ...
                <div className="relative flex justify-center">
                  <button
                    ...
                    className="bg-card px-4 py-2 text-muted-foreground hover:text-foreground text-sm transition-colors flex items-center gap-2 rounded-lg border border-border hover:border-primary/50"
                  >
