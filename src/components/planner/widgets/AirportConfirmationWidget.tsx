...
/**
 * Airport Confirmation Widget
 *
 * Multi-destination airport selection widget with dropdowns for each leg.
 * Allows users to choose between suggested and alternative airports.
 */
    ...
    <div className="mt-3 p-4 rounded-2xl bg-muted/50 border border-border/50 max-w-lg space-y-4">
      ...
      <div className="space-y-3">
        {data.legs.map((leg, idx) => {
          const selected = selectedAirports[leg.legIndex];
          const allFromAirports = [
            leg.from.suggestedAirport,
            ...leg.from.alternativeAirports,
          ];
          const allToAirports = [
            leg.to.suggestedAirport,
            ...leg.to.alternativeAirports,
          ];
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      const airport = allFromAirports.find(
                        (a) => a.iata === e.target.value
                      );
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      const airport = allToAirports.find(
                        (a) => a.iata === e.target.value
                      );
